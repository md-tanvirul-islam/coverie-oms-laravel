...
class UpdateCourierPaidInvoiceRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'consignment_id'   => [
                'required',
                'string',
                Rule::unique('courier_paid_invoices', 'consignment_id')->ignore($this->courier_paid_invoice->id),
            ],
            ...
            'merchant_order_id' =>  [
                'required',
                'string',
                Rule::unique('courier_paid_invoices', 'merchant_order_id')->ignore($this->courier_paid_invoice->id),
            ],
        ];
    }
}
