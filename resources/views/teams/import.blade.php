        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header bg-secondary text-white d-flex justify-content-between">
                    <h5 class="mb-0">Import Teams (Excel Upload)</h5>

                    <div class="btn-group" role="group">
                        <a href="{{ route('teams.index') }}" class="btn btn-primary btn-sm">
                            <i class="bi bi-list"></i> Team List
                        </a>
                        <a href="{{ route('teams.export') }}" class="btn btn-success btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <a href="{{ asset('sample/excel/teams-sample.xlsx') }}" class="btn btn-success">
                            Download Sample Excel
                        </a>
                    </div>

                    <form action="{{ route('teams.import.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
