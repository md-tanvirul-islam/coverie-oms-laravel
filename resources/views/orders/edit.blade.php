    ...
    <div class="card shadow-sm p-4">
        <form method="POST" action="{{ route('orders.update', $order->id) }}">
            ...
            <div class="mb-3">
                ...
                <input name="invoice_id" value="{{ old('invoice_id', $order->invoice_id) }}"
            ...
            <div class="mb-3">
                ...
                <input name="customer_name" value="{{ old('customer_name', $order->customer_name) }}"
            ...
            <div class="mb-3">
                ...
                <input name="customer_phone" value="{{ old('customer_phone', $order->customer_phone) }}"
            ...
            <div class="mb-3">
                ...
                <textarea name="customer_address" class="form-control @error('customer_address') is-invalid @enderror" rows="2">{{ old('customer_address', $order->customer_address) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="1" name="quantity" value="{{ old('quantity', $order->quantity) }}"
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="total_cost" value="{{ old('total_cost', $order->total_cost) }}"
            ...
            <div class="mb-3">
                ...
                <input name="phone_model" value="{{ old('phone_model', $order->phone_model) }}"
            ...
            <div class="mb-3">
                ...
                <select name="employee_id" class="form-control @error('employee_id') is-invalid @enderror" required>
                    ...
                    @foreach ($employees as $id => $name)
                        <option value="{{ $id }}"
                            {{ old('employee_id', $order->employee_id) == $id ? 'selected' : '' }}>
                            {{ $name }}
                        </option>
                    @endforeach
                </select>
