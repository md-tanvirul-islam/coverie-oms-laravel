    ...
    <div class="card shadow-sm p-4">
        <form id="orderForm" enctype="multipart/form-data" @submit.prevent="submitForm">
            ...
            <div x-data="invoiceForm()" class="mt-3">
                ...
                <div class="mt-3">
                    <button type="button" class="btn btn-primary" @click="submitForm()">Create</button>
        ...
        window.invoiceForm = function() {
            return {
                ...
                addFiles(event, index) {
                    ...
                    files.forEach(file => this.items[index].documents.push(file));
                    event.target.value = '';
                },
